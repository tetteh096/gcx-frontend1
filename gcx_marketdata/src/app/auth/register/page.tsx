...
import { ArrowLeft, BarChart3, TrendingUp, Shield, Zap } from 'lucide-react';
      ...
      <div className="flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-600 via-green-700 to-green-800 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-center px-16 py-16 text-white">
            <div className="mb-12">
              <h1 className="text-5xl font-bold mb-6 leading-tight">GCX Market Data Platform</h1>
              <p className="text-xl text-green-100 leading-relaxed max-w-lg">
                Access professional market data, real-time analytics, and comprehensive insights 
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 p-4 bg-white/10 backdrop-blur-sm rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-green-100 text-sm">Live market prices & updates</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-white/10 backdrop-blur-sm rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-green-100 text-sm">Professional charts & insights</p>
                </div>
              </div>
        ...
        {/* Right Side - Bigger Registration Form */}
        <div className="flex-1 flex items-center justify-center px-8 py-12">
          <div className="w-full max-w-2xl">
            <div className="text-center mb-10">
              <h2 className="text-4xl font-bold text-gray-900 mb-3">Create Account</h2>
              <p className="text-xl text-gray-600">Join thousands of traders and analysts</p>
            </div>
            <RegisterForm />
          </div>
        </div>
