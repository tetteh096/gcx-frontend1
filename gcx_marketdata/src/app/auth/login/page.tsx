...
import { ArrowLeft, BarChart3, TrendingUp, Shield, Zap, Users } from 'lucide-react';
          ...
          <div className="relative z-10 flex flex-col justify-center px-16 py-16 text-white">
            <div className="mb-12">
              ...
              <p className="text-xl text-green-100 leading-relaxed max-w-lg">
                Access your professional market data dashboard, real-time analytics, and comprehensive insights 
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 p-4 bg-white/10 backdrop-blur-sm rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-green-100 text-sm">Exclusive data & insights</p>
                </div>
              </div>
        ...
        <div className="flex-1 flex items-center justify-center px-8 py-12">
          <div className="w-full max-w-lg">
            <div className="text-center mb-10">
              ...
              <p className="text-xl text-gray-600">Access your GCX Market Data account</p>
            </div>
            <LoginForm />
          </div>
        </div>
