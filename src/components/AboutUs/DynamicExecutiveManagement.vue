  ...
  <div class="space-y-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
      ...
      >
        ...
        <!-- Clean Content -->
        <div class="p-6">
          <h3 class="text-xl font-semibold mb-2 text-slate-900 dark:text-white group-hover:text-slate-700 dark:group-hover:text-slate-200 transition-colors duration-300">
            {{ member.name }}
          </h3>
    ...
    <div v-if="loading" class="text-center py-12">
      <div class="inline-flex items-center space-x-2">
        ...
        <span class="text-lg" :class="isDarkMode ? 'text-white' : 'text-slate-900'">Loading executive members...</span>
      </div>
    </div>
    ...
    <div v-if="error" class="text-center py-12">
      <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6 max-w-md mx-auto">
        ...
        <h3 class="text-lg font-semibold text-red-800 dark:text-red-200 mb-2">Error Loading Executive Members</h3>
        <p class="text-red-600 dark:text-red-300">{{ error }}</p>
        <button
          @click="loadExecutiveMembers"
...
// State
const executiveMembers = ref<ExecutiveMember[]>([])
const loading = ref(false)
const error = ref('')
const selectedMember = ref<ExecutiveMember | null>(null)
...
const loadExecutiveMembers = async (skipCache = false) => {
  ...
  try {
    ...
    executiveMembers.value = [] // Set empty array on error
  } finally {
    loading.value = false
  }
}
...
const openProfile = (member: ExecutiveMember) => {
