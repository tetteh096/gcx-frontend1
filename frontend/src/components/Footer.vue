      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-12">
        ...
        <div class="lg:col-span-1">
          <div class="flex items-center mb-6">
            <img src="/logo_black.png" alt="GCX Logo" class="h-12 w-auto filter invert mr-3" />
            <span class="text-2xl font-bold">GCX</span>
          </div>
          ...
          <div class="flex space-x-4">
            ...
            <!-- X (Twitter) -->
            <a href="#" class="w-10 h-10 bg-slate-800 hover:bg-black rounded-lg flex items-center justify-center transition-all duration-300 group">
              <svg class="w-5 h-5 text-slate-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Instagram -->
            <a href="#" class="w-10 h-10 bg-slate-800 hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-600 rounded-lg flex items-center justify-center transition-all duration-300 group">
              <svg class="w-5 h-5 text-slate-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- LinkedIn -->
            <a href="#" class="w-10 h-10 bg-slate-800 hover:bg-blue-700 rounded-lg flex items-center justify-center transition-all duration-300 group">
              <svg class="w-5 h-5 text-slate-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li><router-link to="/commodities" class="text-slate-300 hover:text-white transition-colors">Commodities</router-link></li>
            <li><router-link to="/membership/types" class="text-slate-300 hover:text-white transition-colors">Membership Types</router-link></li>
            ...
            <li><router-link to="/location" class="text-slate-300 hover:text-white transition-colors">Location</router-link></li>
          </ul>
        </div>
      ...
      <div class="border-t border-slate-700 mt-12 pt-8">
        <div class="flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex space-x-6 text-sm">
            <router-link to="/privacy" class="text-slate-300 hover:text-white transition-colors">
              Privacy Policy
            </router-link>
            <router-link to="/terms" class="text-slate-300 hover:text-white transition-colors">
              Terms of Service
            </router-link>
            <router-link to="/sitemap" class="text-slate-300 hover:text-white transition-colors">
              Sitemap
            </router-link>
          </div>
        </div>
